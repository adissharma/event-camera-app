...
export default function CoverStep() {
  ...
  // This is the same phone that travels into capture and gallery. The
  // carousel is now its gesture/control surface rather than another set of
  // device frames, so there is no hand-off or match cut on Next.
  useStage('cover');
  useStageDraft(draft);
