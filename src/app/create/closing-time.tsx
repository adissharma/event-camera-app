...
export default function ClosingTimeStep() {
  ...
  const dateReminder = selected.toLocaleDateString('en-GB', {
    weekday: 'long',
    day: 'numeric',
    month: 'long',
  });
  ...
  return (
    <CreationStepScreen step="closing-time" heading={copy.create.closingTimeHeading} headingAlign="center" scrollable={false}>
      <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center', gap: spacing.base }}>
        <AppText variant="bodyLarge" tone="secondary" align="center" style={{ fontFamily: fontFamilies.textMedium, color: colours.textSecondary }}>
          {dateReminder}
        </AppText>
